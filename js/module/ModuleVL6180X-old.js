...
class ClassVL6180X {
    ...
    /**
     * @method
     * реализовует более безопасную работу с методом this._vl6180x.range()
     * @param {*}  
     * @returns 
     */
    getRange() {
        if (this._vl6180x._waitForRange || this._vl6180x._waitForALS) return;
    ...
    /**
     * @method реализовует более безопасную работу с методом this._vl6180x.ambient()
     * @param {*}  
     * @returns 
     */
    getIllumination() {
        if (this._vl6180x._waitForALS || this._vl6180x._waitForRange) return;
